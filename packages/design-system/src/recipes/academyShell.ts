...
export const academyShell = sva({
	...
	base: {
		...
		// Below lg, sign in lives at the top of the navigation drawer.
		...
		menuIdentityText: { display: "grid", minWidth: "0" },
		menuIdentityName: {
			overflow: "hidden",
			color: "academy.text",
			fontWeight: "semibold",
		...
		menuSignOut: {
			...
			fontWeight: "semibold",
			cursor: "pointer",
			_hover: { borderColor: "academy.inputBorder" },
			_focusVisible: { outline: "focus", outlineColor: "academy.accent" },
		},
		menuPrimary: {
			margin: "0",
