...
export const academyCatalog = sva({
	...
	base: {
		...
		identity: { display: "grid", gridTemplateColumns: "auto minmax(0, 1fr) auto", alignItems: "center", gap: "4", minWidth: "0", minHeight: "20", padding: "4", border: "hairline", borderColor: "academy.border", borderRadius: "academy-s", background: "academy.panel", color: "academy.text", textDecoration: "none", transitionProperty: "common", transitionDuration: "fast", _hover: { borderColor: "academy.accent", background: "academy.ground", transform: "translateY(-1px)" }, _focusVisible: { outline: "focus", outlineColor: "academy.accent", outlineOffset: "focus" }, _motionReduce: { transitionDuration: "none", _hover: { transform: "none" } } },
		identityMark: { display: "grid", placeItems: "center", width: "12", height: "12", flexShrink: "0", border: "hairline", borderColor: "academy.border", background: "academy.ground" },
		identityLogo: { width: "8", height: "8", objectFit: "contain" },
		identityBody: { display: "grid", gap: "1", minWidth: "0" },
		identityTitle: { minWidth: "0", overflow: "hidden", color: "academy.text", fontFamily: "academy-display", fontSize: "lg", fontWeight: "bold", lineHeight: "tight", textOverflow: "ellipsis", whiteSpace: "nowrap" },
		identityMeta: { overflow: "hidden", color: "academy.textMuted", fontFamily: "academy-mono", fontSize: "xs", letterSpacing: "wide", textOverflow: "ellipsis", textTransform: "uppercase", whiteSpace: "nowrap" },
		identityArrow: { color: "academy.accent", fontFamily: "academy-mono", fontSize: "lg", lineHeight: "none" },
