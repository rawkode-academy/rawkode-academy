...
export const academyLayout = sva({
	...
	base: {
		...
		prose: { color: "academy.textSoft", fontSize: "lg", lineHeight: "relaxed", overflowWrap: "anywhere", "& > * + *": { marginTop: "6" }, "& h2, & h3, & h4": { color: "academy.text", fontFamily: "academy-display", fontWeight: "bold", lineHeight: "tight" }, "& h2": { fontSize: "3xl" }, "& h3": { fontSize: "2xl" }, "& a": { color: "academy.accent", textDecoration: "underline", textUnderlineOffset: "0.2em" }, "& ul, & ol": { display: "grid", gap: "3", margin: "0", paddingInlineStart: "6" }, "& ul": { listStyle: "disc" }, "& ol": { listStyle: "decimal" }, "& li": { paddingInlineStart: "1" }, "& li::marker": { color: "academy.accent", fontFamily: "academy-mono", fontWeight: "bold" }, "& img": { maxWidth: "full", height: "auto" }, "& pre": { maxWidth: "full", overflowX: "auto", padding: "6", borderRadius: "academy-m", backgroundColor: "academy.ground" } },
