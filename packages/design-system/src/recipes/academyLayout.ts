...
export const academyLayout = sva({
	slots: ["root", "hero", "heroInner", "heroCopy", "heroAside", "container", "kicker", "title", "description", "section", "sectionHeader", "sectionTitle", "grid", "card", "cardMedia", "cardBody", "cardTitle", "meta", "prose", "sidebar", "split", "toolbar", "input", "button", "buttonSecondary", "tag", "empty", "notice", "breadcrumbs", "list", "table", "tableWrap"],
	base: {
		...
		hero: { paddingBlock: "8", paddingInline: "6", backgroundColor: "academy.ground", borderBottom: "hairline", borderColor: "academy.border", _lg: { paddingBlock: "10" } },
		heroInner: { display: "grid", gap: "5", alignItems: "end", _lg: { gridTemplateColumns: "minmax(0, 1.15fr) minmax(18rem, .85fr)", gap: "12" } },
		heroCopy: { display: "grid", gap: "4", minWidth: "0" },
		heroAside: { display: "grid", gap: "4", alignContent: "end", minWidth: "0", _lg: { paddingBlockEnd: "1" } },
		container: { maxWidth: "academy-shell", marginInline: "auto", width: "full", minWidth: "0" },
		kicker: { margin: "0", color: "academy.accent", fontFamily: "academy-mono", fontSize: "xs", letterSpacing: "wide", textTransform: "uppercase" },
		...
		description: { maxWidth: "academy-copy", margin: "0", color: "academy.textSoft", fontSize: "lg", lineHeight: "relaxed", textWrap: "pretty" },
		...
		toolbar: { display: "grid", gridTemplateColumns: "1fr", alignItems: "end", columnGap: "4", rowGap: "2", marginBottom: "8", paddingBlock: "3", borderBottom: "hairline", borderColor: "academy.border", "& > label": { color: "academy.textMuted", fontFamily: "academy-mono", fontSize: "xs", fontWeight: "semibold", letterSpacing: "wide", textTransform: "uppercase" }, "& > p": { justifySelf: "start", margin: "0", color: "academy.textMuted", fontFamily: "academy-mono", fontSize: "xs", letterSpacing: "wide", textTransform: "uppercase" }, _sm: { gridTemplateColumns: "1fr minmax(16rem, 24rem)" }, _lg: { gridTemplateColumns: "auto minmax(16rem, 24rem) 1fr", "& > p": { justifySelf: "end" } } },
		input: { width: "full", minWidth: "0", minHeight: "12", paddingInline: "4", paddingBlock: "2", border: "hairline", borderColor: "academy.inputBorder", borderRadius: "academy-s", backgroundColor: "academy.input", color: "academy.text", font: "inherit", _focusVisible: { outline: "focus", outlineColor: "academy.accent", outlineOffset: "focus" } },
