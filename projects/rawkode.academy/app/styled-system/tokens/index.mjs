const tokens = {
  ...
  "colors.brand.secondary": {
    "value": "rgb(133, 255, 149)",
    "variable": "var(--colors-brand-secondary)"
  },
  "colors.brand.accent": {
    "value": "rgb(35, 40, 45)",
    "variable": "var(--colors-brand-accent)"
  },
  "fonts.sans": {
  ...
  "fonts.display": {
    "value": "var(--font-quicksand), sans-serif",
  ...
  "fonts.mono": {
    "value": "var(--font-monaspace-neon), monospace",
  ...
  "spacing.page": {
    "value": "clamp(1rem, 3vw, 1.75rem)",
    "variable": "var(--spacing-page)"
  },
  "spacing.section": {
    "value": "clamp(3rem, 6vw, 5rem)",
    "variable": "var(--spacing-section)"
  },
  "spacing.stack": {
    "value": "clamp(1.5rem, 3.5vw, 2.5rem)",
    "variable": "var(--spacing-stack)"
  },
  "breakpoints.sm": {
    "value": "640px",
  ...
  "colors.surface.card": {
    "value": "var(--colors-surface-card)",
    "variable": "var(--colors-surface-card)"
  },
  "colors.surface.border": {
    "value": "var(--colors-surface-border)",
    "variable": "var(--colors-surface-border)"
  },
  "colors.text.primary": {
  ...
  "spacing.-page": {
    "value": "calc(var(--spacing-page) * -1)",
    "variable": "var(--spacing-page)"
  },
  "spacing.-section": {
    "value": "calc(var(--spacing-section) * -1)",
    "variable": "var(--spacing-section)"
  },
  "spacing.-stack": {
    "value": "calc(var(--spacing-stack) * -1)",
    "variable": "var(--spacing-stack)"
  },
  "colors.colorPalette": {
