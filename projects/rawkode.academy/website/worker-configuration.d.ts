/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./wrangler.jsonc -c ../platform/email-preferences/http/wrangler.jsonc -c ../platform/notifications/wrangler.jsonc -c ../games/secrets-of-kubernetes/achievements/http/wrangler.jsonc -c ../games/secrets-of-kubernetes/leaderboard/http/wrangler.jsonc -c ../games/secrets-of-kubernetes/player-learned-phrases/http/wrangler.jsonc -c ../games/secrets-of-kubernetes/player-stats/http/wrangler.jsonc -c ../games/secrets-of-kubernetes/share-cards/http/wrangler.jsonc` (hash: ddac329476a535a634ffa6dbc1995c91)
// Runtime types generated with workerd@1.20260529.1 2026-03-12 nodejs_compat
interface __BaseEnv_Env {
	...
	WATCH_HISTORY: Fetcher /* platform-watch-history-write-model */;
	BRACKETS_READ: Fetcher /* platform-brackets-read-model */;
	BRACKETS_WRITE: Fetcher /* platform-brackets-write-model */;
	IDENTITY: Fetcher /* rawkode-academy-identity */;
	EMAIL_PREFERENCES: Service<typeof import("../platform/email-preferences/http/http-service").EmailPreferences>;
	ANALYTICS: Fetcher /* rawkode-tools-observability-collector */;
	NOTIFICATIONS: Service<typeof import("../platform/notifications/src/main").Notifications>;
	STUDIO: Fetcher /* rawkode-academy-studio */;
	SKI_PLAYER_STATS: Service<typeof import("../games/secrets-of-kubernetes/player-stats/http/http-service").SkiPlayerStats>;
	SKI_PLAYER_LEARNED_PHRASES: Service<typeof import("../games/secrets-of-kubernetes/player-learned-phrases/http/http-service").SkiPlayerLearnedPhrases>;
	...
	LEADERBOARD_READ: Fetcher /* platform-leaderboard-read-model */;
	LEADERBOARD_WRITE: Service<typeof import("../platform/leaderboard/write-model/main").LeaderboardWriteModel>;
	ACHIEVEMENTS_READ: Fetcher /* platform-achievements-read-model */;
	ACHIEVEMENTS_WRITE: Service<typeof import("../platform/achievements/write-model/main").AchievementsWriteModel>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CLOUDFLARE_ACCOUNT_ID" | "NOTIFICATIONS_VAPID_PUBLIC_KEY">> {}
}
