/* eslint-disable */
// Generated by Wrangler by running `wrangler types -c ./wrangler.jsonc -c ../platform/email-preferences/rpc/wrangler.jsonc -c ../games/secrets-of-kubernetes/achievements/http/wrangler.jsonc -c ../games/secrets-of-kubernetes/leaderboard/http/wrangler.jsonc -c ../games/secrets-of-kubernetes/player-learned-phrases/http/wrangler.jsonc -c ../games/secrets-of-kubernetes/player-stats/http/wrangler.jsonc -c ../games/secrets-of-kubernetes/share-cards/http/wrangler.jsonc` (hash: 01316b0b3c8eddb259adbbaec8e76d85)
// Runtime types generated with workerd@1.20251202.0 2025-05-05 nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		EMAIL_PREFERENCES: Service /* entrypoint EmailPreferences from platform-email-preferences-rpc */;
		ANALYTICS: Fetcher /* analytics */;
		SKI_PLAYER_STATS: Service /* entrypoint SkiPlayerStats from games-ski-player-stats-rpc */;
		SKI_PLAYER_LEARNED_PHRASES: Service /* entrypoint SkiPlayerLearnedPhrases from games-ski-player-learned-phrases-rpc */;
		SKI_ACHIEVEMENTS: Service /* entrypoint SkiAchievements from games-ski-achievements-rpc */;
		SKI_LEADERBOARD: Service /* entrypoint SkiLeaderboard from games-ski-leaderboard-rpc */;
		SKI_SHARE_CARDS: Service /* entrypoint SkiShareCards from games-ski-share-cards-rpc */;
		ASSETS: Fetcher;
	}
}
