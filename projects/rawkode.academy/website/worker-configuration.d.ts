/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 14a233d1337574cdd5fce964038854a0)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		PUBLIC_GRAFANA_FARO_APP_NAME: "rawkode-academy-website";
		EMOJI_REACTIONS: Fetcher /* platform-emoji-reactions-write-model */;
		IDENTITY: Fetcher /* rawkode-academy-identity */;
		EMAIL_PREFERENCES: Fetcher /* platform-email-preferences-rpc */;
		EMAIL_SERVICE: Fetcher /* platform-email-service-rpc */;
		ANALYTICS: Fetcher /* analytics */;
		SKI_PLAYER_STATS: Fetcher /* games-ski-player-stats-rpc */;
		SKI_PLAYER_LEARNED_PHRASES: Fetcher /* games-ski-player-learned-phrases-rpc */;
		SKI_ACHIEVEMENTS: Fetcher /* games-ski-achievements-rpc */;
		SKI_LEADERBOARD: Fetcher /* games-ski-leaderboard-rpc */;
		SKI_DAILY_CHALLENGE_READ: Fetcher /* platform-ski-daily-challenge-read-model */;
		SKI_DAILY_CHALLENGE_RPC: Fetcher /* platform-ski-daily-challenge-rpc */;
		SKI_SHARE_CARDS: Fetcher /* games-ski-share-cards-rpc */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_GRAFANA_FARO_URL" | "PUBLIC_GRAFANA_FARO_APP_NAME">> {}
}
