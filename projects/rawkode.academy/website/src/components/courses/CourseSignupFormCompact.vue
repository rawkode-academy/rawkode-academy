  ...
  <div class="space-y-4">
    ...
    <form v-else @submit.prevent="submitForm" class="space-y-4">
      ...
      <button
        type="submit"
        :disabled="loading"
        class="flex w-full items-center justify-center rounded-full bg-[var(--surface-card)] px-4 py-3 font-semibold text-white shadow-lg transition-transform duration-200 hover:-translate-y-0.5 disabled:translate-y-0 disabled:cursor-not-allowed disabled:opacity-60"
      >
