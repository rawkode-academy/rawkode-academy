    ...
    <div :class="css({ bg: { base: 'white', _dark: 'gray.800' }, p: '8', rounded: 'xl', shadow: 'lg', borderWidth: '1px', borderColor: { base: 'gray.200/50', _dark: 'gray.700/50' } })">
      ...
      <div v-if="checkingSubscription" :class="css({ textAlign: 'center', py: '8' })">
        <div :class="css({ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', w: '16', h: '16', rounded: 'full', bg: { base: 'gray.100', _dark: 'gray.700' }, mb: '6' })">
          <svg :class="css({ animation: 'spin', h: '8', w: '8', color: 'primary' })" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <p class="text-secondary-content" :style="{ fontSize: '1.125rem' }">Checking subscription status...</p>
      </div>
      ...
      <div v-else-if="isAlreadySubscribed" :class="css({ textAlign: 'center', py: '8' })">
        <div :class="css({ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', w: '16', h: '16', rounded: 'full', bg: { base: 'primary/10', _dark: 'primary/20' }, mb: '6' })">
          <svg xmlns="http://www.w3.org/2000/svg" :class="css({ h: '8', w: '8', color: 'primary' })" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
          </svg>
        </div>
        <h3 :class="css({ fontSize: '2xl', fontWeight: 'bold', mb: '3' }) + ' text-primary-content'">You're Already Subscribed!</h3>
        <p class="text-secondary-content" :style="{ fontSize: '1.125rem' }">
      ...
      <div v-else-if="submitted" :class="css({ textAlign: 'center', py: '8' })">
        ...
        <h3 :class="css({ fontSize: '2xl', fontWeight: 'bold', mb: '3' }) + ' text-primary-content'">Thank You!</h3>
        <p :class="css({ fontSize: 'lg', mb: '6' }) + ' text-secondary-content'">
      ...
      <!-- Form -->
      <template v-else>
        <p :class="css({ mb: '6', textAlign: 'center' }) + ' text-secondary-content'">
        ...
        <form @submit.prevent="submitForm" :class="css({ display: 'flex', flexDir: 'column', gap: '4' })">
          <div v-if="!userEmail">
            ...
            <input
              ...
              :class="css({ w: 'full', px: '4', py: '2', borderWidth: '1px', borderColor: { base: 'gray.300', _dark: 'gray.600' }, rounded: 'lg', bg: { base: 'white', _dark: 'gray.700' }, _focus: { ringWidth: '2px', ringColor: 'primary', borderColor: 'primary' } }) + ' text-primary-content'"
            />
          </div>
          ...
          <div v-if="allowSponsorContact && sponsor" :class="css({ display: 'flex', alignItems: 'start' })">
            <input
              ...
              value="true"
              :class="css({ mt: '1', h: '4', w: '4', color: 'primary', borderColor: 'gray.300', rounded: 'sm', _focus: { ringColor: 'primary' } })"
            />
          ...
          <button
            type="submit"
            :disabled="submitting"
            :class="css({ w: 'full', bg: 'primary', color: 'white', fontWeight: 'medium', py: '3', px: '4', rounded: 'lg', transition: 'colors', display: 'flex', alignItems: 'center', justifyContent: 'center', _hover: { bg: 'primary/90' }, _disabled: { opacity: '0.5', cursor: 'not-allowed' } })"
          >
