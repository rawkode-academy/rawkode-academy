...
const spinnerStyle = css({ display: 'inline-block', animation: 'spin 1s linear infinite', borderRadius: 'full', h: '8', w: '8', borderWidth: '4px', borderColor: 'gray.300', borderTopColor: 'colorPalette.default' });
