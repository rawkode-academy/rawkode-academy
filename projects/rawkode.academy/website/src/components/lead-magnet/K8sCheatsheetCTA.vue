...
<template>
	<section class="relative overflow-hidden paper-card p-4 sm:p-6 md:p-8 lg:p-12 bg-[var(--editorial-ink)] text-[var(--editorial-paper)] rounded-xl sm:rounded-2xl">
					...
					>
						...
						>
							...
							<a
								...
								class="ed-btn ed-btn--solid ed-btn--md flex items-center justify-center w-full py-2.5 sm:py-3 px-4 text-sm sm:text-base font-semibold shadow-lg hover:shadow-xl"
							>
					...
					<div v-if="!showSuccessState">
						...
						<template v-if="isSignedIn">
							<button
								@click="subscribeAsLearner"
								:disabled="isLoading"
								class="ed-btn ed-btn--solid ed-btn--md w-full py-2.5 sm:py-3 px-4 text-sm sm:text-base font-semibold shadow-lg hover:shadow-xl disabled:opacity-70 disabled:cursor-wait min-h-[44px] sm:min-h-[48px]"
							>
						...
						<template v-else>
							<div class="space-y-3 sm:space-y-4">
								...
								<a
									...
									class="ed-btn ed-btn--solid ed-btn--md flex items-center justify-center w-full py-2.5 sm:py-3 px-4 text-sm sm:text-base font-semibold shadow-lg hover:shadow-xl min-h-[44px] sm:min-h-[48px]"
								>
