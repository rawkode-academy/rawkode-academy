...
const overlayStyle = css({
	...
	inset: '0',
	backgroundImage:
		'linear-gradient(to top right, rgb(var(--brand-primary) / 0.3), rgb(var(--brand-primary) / 0.2))',
...
const avatarImgStyle = css({ w: '10', h: '10', borderRadius: 'full', objectFit: 'cover', borderWidth: '2px', borderColor: 'brandAccent.border', p: '0.5', bg: { base: 'white', _dark: 'gray.800' } });
const indicatorStyle = css({ position: 'absolute', bottom: '0', right: '0', h: '2.5', w: '2.5', bg: 'brandAccent.solid', borderRadius: 'full', borderWidth: '2px', borderColor: { base: 'white', _dark: 'gray.700' } });
const overflowStyle = css({ w: '10', h: '10', borderRadius: 'full', bg: 'brandAccent.subtle', borderWidth: '2px', borderColor: 'brandAccent.border', p: '0.5', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 'xs', color: 'brandAccent.text', fontWeight: 'medium' });
...
const svgPrimaryStyle = css({ h: '4', w: '4', color: 'brandAccent.text' });
</script>
