	...
	<div v-if="links.length > 0" class="flex flex-col gap-3">
		...
		<div class="flex flex-wrap gap-2">
			<a
				...
				class="hairline-chip gap-2 rounded-lg px-4 py-2 text-sm font-medium text-secondary-content transition-smooth hover:shadow-md hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2"
