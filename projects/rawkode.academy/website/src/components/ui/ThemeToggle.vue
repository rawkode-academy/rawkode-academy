<template>
	...
	>
		...
		<transition name="fade" mode="out-in">
			...
			>
				<circle cx="12" cy="12" r="10" stroke-width="2" :class="css({ stroke: 'colorPalette.default' })" />
				<circle cx="12" cy="12" r="6" fill="currentColor" :class="css({ fill: 'colorPalette.default' })" />
			</svg>
		</transition>
