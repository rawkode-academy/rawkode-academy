...
export function registerTechnologies(
	...
	const LearningResourcesRef =
		builder.objectRef<LearningResources>("LearningResources");
	builder.objectType(LearningResourcesRef, {
		fields: (t: any) => ({
			official: t.field({
				type: ["String"],
				resolve: (lr: LearningResources) => lr?.official ?? [],
			}),
			community: t.field({
				type: ["String"],
				resolve: (lr: LearningResources) => lr?.community ?? [],
			}),
			tutorials: t.field({
				type: ["String"],
				resolve: (lr: LearningResources) => lr?.tutorials ?? [],
			}),
		}),
	});
	...
	builder.objectType(TechnologyRef, {
		fields: (t: any) => ({
			...
			icon: t.field({
				type: "String",
				nullable: true,
				resolve: (r: TechnologyItem) => r.icon ?? undefined,
			}),
			...
			source: t.field({
				type: "String",
				nullable: true,
				resolve: (r: TechnologyItem) => r.source ?? undefined,
			}),
			...
			aliases: t.field({
				type: ["String"],
				nullable: true,
				resolve: (r: TechnologyItem) => r.aliases ?? null,
			}),
			relatedTechnologies: t.field({
				type: ["String"],
				nullable: true,
			...
			useCases: t.field({
				type: ["String"],
				nullable: true,
				resolve: (r: TechnologyItem) => r.useCases ?? null,
			}),
			features: t.field({
				type: ["String"],
				nullable: true,
				resolve: (r: TechnologyItem) => r.features ?? null,
			}),
			learningResources: t.field({
				type: LearningResourcesRef,
				nullable: true,
				resolve: (r: TechnologyItem) => r.learningResources ?? null,
			}),
			status: t.field({
				type: "String",
				nullable: true,
				resolve: (r: TechnologyItem) => r.status ?? undefined,
			}),
		}),
	});
