...
export const IMAGE_SERVICE_TEMPLATE_VERSION = "2026-05-24-2";
...
export const encodeImageServicePayload = (
  payload: ImageServicePayload,
): string => encodeBytes(textEncoder.encode(JSON.stringify(payload)));
