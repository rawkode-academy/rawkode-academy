<script lang="ts">
  ...
  import { buildCommentTree, commentAnchor, type ApiComment, type CommentNode } from "@/shared/contracts";
  import { COMMENT_BODY_MAX_LENGTH } from "@/shared/input-limits";
  import { buttonPrimarySmClass, buttonSecondarySmClass, textareaClass } from "@/shared/ui/classes";
  import CommentBranch from "@/components/posts/comments/CommentBranch.svelte";
