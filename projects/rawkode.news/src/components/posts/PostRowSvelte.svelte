<script lang="ts">
  import type { ApiPost } from "@/shared/contracts";
  import { formatCountLabel, formatRelativeTime, postPath } from "@/shared/contracts";
  import { getExternalDomainLabel } from "@/shared/urls/domain-label";
  import { stripMarkdownToText, truncateDescription } from "@/shared/seo";
