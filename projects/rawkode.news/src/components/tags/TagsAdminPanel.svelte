<script lang="ts">
  ...
  import type { ApiTag } from "@/shared/contracts";
  import { deriveTagSlug } from "@/domains/tags/model";
  import CreateTagForm from "@/components/tags/admin/CreateTagForm.svelte";
  import TagsTable from "@/components/tags/admin/TagsTable.svelte";
  import DeleteTagDialog from "@/components/tags/admin/DeleteTagDialog.svelte";
  import {
    buildPageItems,
    normalizeSlug,
    parsePageValue,
    ...
    type EditState,
    type PageItem,
  } from "@/components/tags/admin/shared";
