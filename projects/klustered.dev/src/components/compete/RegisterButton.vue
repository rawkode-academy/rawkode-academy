...
function getCardActionText(cardId: string): string {
	...
	if (isLoading.value === cardId) {
		return isSelected ? "Withdrawing..." : "Applying...";
	}
	return isSelected ? "Click to withdraw" : "Click to apply";
}
...
<template>
	<div class="registration-container">
		...
		<template v-if="!isSignedIn">
			<p class="sign-in-prompt">Sign in to apply for competition</p>
		...
		<template v-else>
			<div class="cards-grid">
				...
				>
					...
					<p class="card-description">Apply for both solo and team competitions</p>
