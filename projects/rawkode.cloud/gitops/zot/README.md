...
2. Persistence is enabled and expects a default `StorageClass`. Set `pvc.storageClassName` in [`helm-release.yaml`](./helm-release.yaml) if this cluster needs an explicit class.
