...
env: environment: production: {
	INFISICAL_UNIVERSAL_AUTH_CLIENT_ID: schema.#OnePasswordRef & {ref: "op://rawkode.cloud/infisical/username"}
	INFISICAL_UNIVERSAL_AUTH_CLIENT_SECRET: schema.#OnePasswordRef & {ref: "op://rawkode.cloud/infisical/password"}
