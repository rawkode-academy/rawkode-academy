---
title: "What Is Zitadel? Open-Source Identity and Access Management Explained"
slug: "introduction"
description: |
...
resources:
  - title: "Zitadel Documentation"
    description: "Official Zitadel documentation"
    type: "url"
  ...
  - title: "Authentication Basics"
    description: "Understanding OAuth2 and OpenID Connect"
    type: "url"
    url: "https://oauth.net/2/"
    category: "documentation"
  - title: "OAuth PKCE Interactive Demo"
    description: "Try the OAuth PKCE flow right in your browser - Enter your Zitadel instance URL and client ID to test authentication"
    type: "embed"
    embedConfig:
      container: "webcontainer"
      src: "oauth-pkce-intro"
      height: "800px"
      startCommand: "bun run dev"
      import:
        localDir: "../complete-guide-zitadel/examples/oauth-pkce-app"
    category: "code"
---
