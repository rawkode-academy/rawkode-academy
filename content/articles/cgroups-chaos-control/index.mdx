...
description: "A deep dive into Linux cgroups v1 vs v2: the history, the architecture, and what it means for Kubernetes."
type: guide
...
Every Linux container's resource limits live, underneath, in a folder.
