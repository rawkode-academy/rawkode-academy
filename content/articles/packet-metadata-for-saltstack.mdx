...
In my last [article](/read/saltstack-on-packet-with-pulumi), we spun up some bare metal compute on [Packet](https://www.packet.com) with [Pulumi](https://www.pulumi.com) and installed [SaltStack](https://www.saltstack.com).
