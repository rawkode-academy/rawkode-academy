...
<Diagram id="federated-graphql-stack" title="Federated GraphQL service stack" description="An API client sends requests through WunderGraph Cosmo to two services. Each service uses GraphQL Yoga, Drizzle ORM, and its own libSQL or Turso database.">
