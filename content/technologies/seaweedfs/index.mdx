...
name: SeaweedFS
seo:
  title: 'SeaweedFS: S3-Compatible Distributed Storage'
  description: 'SeaweedFS is a fast distributed file and object store with S3, FUSE, WebDAV, tiering, replication, and Kubernetes CSI support.'
