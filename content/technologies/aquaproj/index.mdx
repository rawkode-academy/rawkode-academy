...
aquaproj (aqua) provides declarative, reproducible management of CLI tools via a single configuration file, ensuring consistent versions across machines and CI pipelines.
