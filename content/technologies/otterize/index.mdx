...
name: Otterize
seo:
  title: 'Otterize: Kubernetes Intent-Based Access Control'
  description: 'Otterize turns service intent into Kubernetes NetworkPolicies, mesh authorization, database grants, IAM roles, and Kafka ACLs.'
logos:
  horizontal: true
