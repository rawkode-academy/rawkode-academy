...
radar:
  ...
  lastUsed: "Present"
  makesMeFeel: "🚀"
  why: "eBPF-powered networking that replaces kube-proxy, provides incredible observability with Hubble, and makes service mesh sidecars optional. The future of K8s networking."
  spicyTake: "If you're still running Calico in 2024, you're leaving performance and observability on the table."
---
