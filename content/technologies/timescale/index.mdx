...
name: TimescaleDB
seo:
  title: 'TimescaleDB: PostgreSQL Time-Series Database'
  description: 'TimescaleDB turns Postgres into a time-series database with hypertables, compression, continuous aggregates, and SQL-native observability data.'
logos:
  horizontal: true
