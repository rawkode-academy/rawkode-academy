...
description: >-
  In the cloud-native ecosystem, maintaining a secure software supply chain for
  cloud-native workloads is essential. This session will provide real-world
  examples of how to use open-source tools Notary Project, ORAS and Ratify to
  ensure the integrity and authenticity of cloud-native workloads on
  Kubernetes.\n\n- Background\n- Why ensuring integrity and authenticity?\n-
  End-to-End sign and verification experience\n- CNCF project Notary Project
