...
description: >-
  Cyphernetes (Cypher for Kubernetes) is a new language and your next
  superpower.\n\nExpress CRUD operations spanning multiple kinds with a compact
  syntax that is easy to read and a joy to write.\n\nForget nested kubectl
  commands. The Cyphernetes shell comes fully loaded with autocompletion, syntax
  highlighting and more. Craft custom response payloads in a snap!\n\nAn
